...
7. In the *Vagrant Host URL* box, make sure `ssh://vagrant@127.0.0.1:2222` is specified.
    ...
    {{<image src="4.png" title="Interpreter Settings" alt="">}}
