...
1. Create a new storage account and make sure to set the account kind to ``StorageV2`` and the location to ``West Central US``. {{<img src="/blog/Default-Document-Azure-Storage-Account/create.png" title="storage account" alt="storage account">}}
...
4. Fill in the file names that you plan to use and select **Save**. {{<img src="/blog/Default-Document-Azure-Storage-Account/configure.png" title="configure" alt="configure">}}
...
When I browsed to the primary endpoint URL, my default document was being used. {{<img src="/blog/Default-Document-Azure-Storage-Account/default.png" title="default" alt="default">}} I also tested out a 404 error, which worked as expected. {{<img src="/blog/Default-Document-Azure-Storage-Account/404.png" title="404" alt="404">}} You can download the html files from this [repo]( https://github.com/jrudley/staticwebsite).
