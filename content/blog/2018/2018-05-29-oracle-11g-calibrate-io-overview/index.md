...
{{<image src="QueryResponse.png" title="List cell command results" alt="List cell command results">}}
...
{{<image src="CalibrationResponse.png" title="List cell command results" alt="List cell command results">}}
