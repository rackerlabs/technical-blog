...
Second, the training accuracy of the best candidate, which we fully expected to be very bad for AutoML used against an imbalanced classification problem with no preprocessing to address the imbalance.
