...
As a part of Open Cloud day at OSCON, Tuesday at 9:15, **Rainya Mosher** will be talking about [Release engineering downstream of an OpenStack project](http://www.oscon.com/open-source-2015/public/schedule/detail/44790). Rainya is a software development manager within the Public Cloud Infrastructure group and will be speaking on her experience over three years of OpenStack-based operations, covering the the best practices that have led to a successful engineering process.
